...
static const char *dmenucmd[] = { "dmenu_run", "-h", "36", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
...
static const char *alsacmd[]  = { "pavucontrol", NULL };
static const char *newscmd[]  = { "kitty", "-e", "newsboat", NULL };
static const char *weathercmd[]  = { "kitty", "-e", "weather", NULL };
static const char *browser[]  = { "firefox", NULL };
static const char *ytcmd[]  = { "yt", "-g", NULL };
static const char *livecmd[]  = { "streams", NULL };
static const char *htop[]  = { "kitty", "-e", "htop", NULL };
static const char *ytmusiccmd[]  = { "yt", "-g", "-m", NULL };
